...
// Autentikasi hanya untuk role asisten
                ...
                ?>
                    ...
                    <li>
                        <a href="dashboard.php"
                            class="<?= $activePage === 'dashboard' ? $activeClass : $inactiveClass ?> flex items-center px-4 py-3 rounded-md transition-colors duration-200">
                    ...
                    <li>
                        <a href="modul.php"
                            class="<?= $activePage === 'modul' ? $activeClass : $inactiveClass ?> flex items-center px-4 py-3 rounded-md transition-colors duration-200">
                            <svg class="w-5 h-5 mr-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M12 6.042A8.967 8.967 0 006 3.75
                                   ...
                                   m0-14.25a8.966 8.966 0 016-2.292
                                   c1.052 0 2.062.18 3 .512v14.25
                                   A8.987 8.987 0 0018 18a8.967 8.967 0 00-6 2.292
                                   m0-14.25v14.25" />
                            </svg>
                    ...
                    <li>
                        <a href="laporan.php"
                            class="<?= $activePage === 'laporan' ? $activeClass : $inactiveClass ?> flex items-center px-4 py-3 rounded-md transition-colors duration-200">
                            <svg class="w-5 h-5 mr-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 002.25-2.25V6.108
                                   c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 00-1.123-.08
                                   m-5.801 0c-.065.21-.1.433-.1.664
                                   0 .414.336.75.75.75h4.5a.75.75 0 00.75-.75
                                   c0-.231-.035-.454-.1-.664
                                   M6.75 7.5h1.5M6.75 12h1.5m6.75 0h1.5
                                   m-1.5 3h1.5m-1.5 3h1.5M4.5 6.75h1.5v1.5H4.5v-1.5
                                   zM4.5 12h1.5v1.5H4.5v-1.5zM4.5 17.25h1.5v1.5H4.5v-1.5z" />
                            </svg>
                    ...
                    <li>
                        <a href="users.php"
                            class="<?= $activePage === 'users' ? $activeClass : $inactiveClass ?> flex items-center px-4 py-3 rounded-md transition-colors duration-200">
                            <svg class="w-5 h-5 mr-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 6a3.75 3.75 0 11-7.5 0
                                   a3.75 3.75 0 017.5 0zM4.501 20.118
                                   A7.5 7.5 0 0112 15.75c2.062 0 3.936.832 5.291 2.181
                                   A7.5 7.5 0 0112 21a7.5 7.5 0 01-7.499-.882z" />
                            </svg>
